...
main_ax.set_title('Distribution of the eigenvalues of $C_{ij}$',fontsize=15)
main_ax.set_xlabel('$\lambda$ of $C_{ij}$',fontsize=15)
main_ax.set_ylabel('P($\lambda$)',fontsize=15)
main_ax.grid()
main_ax.set_xlim(-0.5, 15)
main_ax.set_yscale('log')

right_inset_ax = fig.add_axes([.55, .5, .3, .3])
right_inset_ax.grid()
right_inset_ax.set_xlim(120, 122)
right_inset_ax.set_yscale('log')
right_inset_ax.set_xlabel('$\lambda$ of $C_{ij}$',fontsize=10)
right_inset_ax.set_ylabel('P($\lambda$)',fontsize=10)

main_ax.hist(y, N, density=True)
main_ax.plot(l, pdf, 'k')
right_inset_ax.hist(y, N, density=True)
